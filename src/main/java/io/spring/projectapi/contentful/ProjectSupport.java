...
public class ProjectSupport {
	...
	@JsonFormat(pattern = "yyyy-MM-dd")
	private final LocalDate ossEnforcedEnd;

	@JsonFormat(pattern = "yyyy-MM-dd")
	private final LocalDate ossPolicyEnd;

	@JsonFormat(pattern = "yyyy-MM-dd")
	private final LocalDate commercialEnforcedEnd;

	@JsonFormat(pattern = "yyyy-MM-dd")
	private final LocalDate commercialPolicyEnd;

	@JsonCreator(mode = Mode.PROPERTIES)
	public ProjectSupport(String branch, LocalDate initialRelease, LocalDate ossEnforcedEnd, LocalDate ossPolicyEnd,
			LocalDate commercialEnforcedEnd, LocalDate commercialPolicyEnd) {
		this.branch = branch;
		this.initialDate = initialRelease;
		this.ossEnforcedEnd = ossEnforcedEnd;
		this.ossPolicyEnd = ossPolicyEnd;
		this.commercialEnforcedEnd = commercialEnforcedEnd;
	...
	public LocalDate getOssEnforcedEnd() {
		return this.ossEnforcedEnd;
	}
	...
	public LocalDate getCommercialEnforcedEnd() {
		return this.commercialEnforcedEnd;
	}
