...
class GithubAuthenticationManager implements AuthenticationManager {
	...
	GithubAuthenticationManager(RestTemplateBuilder builder, ApplicationProperties properties) {
		this.restTemplate = builder.build();
		this.org = properties.getGithub().getOrg();
		this.team = properties.getGithub().getTeam();
	}
